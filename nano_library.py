...
class K40_CLASS:
        ...
        for line in packets:
            ...
            while cnt < self.n_timeouts and True:
                try:
                    ...
                    cnt = cnt + 1
                    update_gui("Timeout #%d, packet number %d of %d" %
                               (cnt, packet_cnt, len(packets)))
    ...
    def read_data(self):
        ...
        while True:
            try:
                data.append(self.dev.read(self.read_addr,
    ...
    def initialize_device(self, verbose=False):
        ...
        # dev.ctrl_transfer(bmRequestType, bRequest, wValue=0, wIndex=0,
        # data_or_wLength = None, 2000)
