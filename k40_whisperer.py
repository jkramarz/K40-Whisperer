...
class Application(Frame):
    ...
    def createWidgets(self):
        ...
        try:
            self.left_image  = ImageTk.PhotoImage(file="images/left.png")
            self.right_image = ImageTk.PhotoImage(file="images/right.png")
            self.up_image    = ImageTk.PhotoImage(file="images/up.png")
            self.down_image  = ImageTk.PhotoImage(file="images/down.png")
            ...
            self.UL_image  = ImageTk.PhotoImage(file="images/UL.png")
            self.UR_image  = ImageTk.PhotoImage(file="images/UR.png")
            self.LR_image  = ImageTk.PhotoImage(file="images/LR.png")
            self.LL_image  = ImageTk.PhotoImage(file="images/LL.png")
            self.CC_image  = ImageTk.PhotoImage(file="images/CC.png")
